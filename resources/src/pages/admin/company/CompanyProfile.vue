...
<template>
  <PageHeader title="Les informations du Societe"> </PageHeader>

  <div class="settings-page-wrap">
    <form @submit.prevent="submitForm">
      <div class="setting-title">
        <h4>Modifier les informations du Societe</h4>
      </div>

      <div class="profile-pic-upload">
        <div class="profile-pic">
          <span
            ><i data-feather="plus-circle" class="plus-down-add"></i> Logo du
            Societe</span
          >
        </div>
      ...
      <a-divider class="!text-xl">Generale Informations</a-divider>
      <div class="row mt-3">
        <div class="col-md-3">
          <div class="mb-3">
            <a-form-item
      ...
      <a-divider class="!text-xl">Capital et autres Informations</a-divider>
      <div class="row">
        <div class="col-md-12">
          <div class="mb-3">
            <a-form-item>
