<script setup lang="ts">
  ...
  const data = ref<BankAccount>({
    bank_name: store.currentBankAccount.bank_name,
    account_number: store.currentBankAccount.account_number,
    balance: store.currentBankAccount.balance,
    account_holder_name: store.currentBankAccount.account_holder_name,
    account_holder_phone: store.currentBankAccount.account_holder_phone,
    account_holder_email: store.currentBankAccount.account_holder_email,
  });
    ...
    <section class="grid grid-cols-2 gap-4">
      <div class="grid gap-4">
        ...
        >
          <a-input
            type="text"
            addonBefore="Nom de la banque"
            v-model:value="data.bank_name"
        ...
        >
          <a-input
            addonBefore="Nom du titulaire"
            v-model:value="data.account_holder_name"
      ...
      <div>
        <a-form-item
          :validate-status="isError('account_holder_phone')"
          :help="getErrorMessage('account_holder_phone')"
        >
          <a-input
            type="number"
            addonBefore="Tel"
            v-model:value="data.account_holder_phone"
            @change="clearError('account_holder_phone')"
          />
        </a-form-item>

        <a-form-item
          :validate-status="isError('account_holder_email')"
          :help="getErrorMessage('account_holder_email')"
        >
          <a-input
            type="email"
            addonBefore="Email"
            v-model:value="data.account_holder_email"
